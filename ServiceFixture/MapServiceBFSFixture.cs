...
{
    [TestFixture]
    class MapServiceBFSFixture
    {
        [Test]
        public void testBFSNoHits()
        {
        ...
        [Test]
        public void testBFSNumberOfVisitedCells1()
        {
            //0     23       246       245     225     205     88   
            //114   98       220       129     241     112     254
            //173   207      231       246     125     57      251
            ...
            Assert.AreEqual(220, result.TotalCountOfVisitedCells, "Wrong number of visited cells for BFS.");
        }

        [Test]
        public void testBFSNumberOfVisitedCells2()
        {
            //0     1       10   
            //10    8       10
            //10    1       0
            ...
            Assert.AreEqual(23, result.TotalCountOfVisitedCells, "Wrong number of visited cells for BFS.");
        }
    }
}
